...
if __name__ == '__main__':
    # reduced = reduce_stages([[ [[ ['entry', 'ob', 'target', 'collect1', 'any1'], ['entry', 'ob', 'run', 'collect2', 'any2'] ], 'align0', 'or1'], ['entry', 'ob', 'exposures', 'expmjd>1', 'collect3', 'any3'] ], 'align1', '...', 'end'])
    # print(reduced)
    # print_nested_list(reduced)
    ...
    #
    #
    # subqueries = parse_tree3(final)
    # print_nested_list(reduce_stages(subqueries))

    from tree_test_weaveio_example import red_spectra
    # plot(red_spectra.relevant_graph, '/opt/project/weaveio_example_querytree_red_branch.png')
    subqueries = parse_tree3(red_spectra.results({}))
    print_nested_list(reduce_stages(subqueries))
