...
with data.write:
    data.write_files(*fs, timeout=5*60, debug=True, do_not_apply_constraints=False, batch_size=1,
                     test_one=True, debug_time=True, debug_params=False, dryrun=False, halt_on_error=True, parts=['GAND'])
data.validate(fs)
